...
return(
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="#">FORTUNE WOODS</a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <li><Link className="dropdown-item" to="/Sofa">Sofa</Link></li>
          <li><Link className="dropdown-item" to="/Chair">Chair</Link></li>
          </ul>
        </li>
        <li className="nav-item dropdown">
         <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
           ...
           { loginData ?<li><Link className="dropdown-item" to="/order">MyOrder</Link></li> :<li><Link className="dropdown-item" to="/Register">Signup</Link></li>}
